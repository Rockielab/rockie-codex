...
```bash
python3 .agents/skills/deploy-team/runtime/orchestrator.py \
    --template gauntlet \
...
Custom templates live in `.agents/skills/deploy-team/templates/*.json`.
...
- Codex CLI rate-limiting — if you hit it, reduce parallel count or wait.
